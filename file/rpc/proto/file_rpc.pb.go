...
type FileInfoRequest struct {
	...
	FileUuid string `protobuf:"bytes,1,opt,name=file_uuid,json=fileUuid,proto3" json:"file_uuid,omitempty"` // 聊天消息， 一个完整的 chatModel 的序列化数据
}
...
func (x *FileInfoRequest) GetFileUuid() string {
	if x != nil {
		return x.FileUuid
	}
	return ""
...
var file_file_rpc_proto_rawDesc = []byte{
	...
	0x12, 0x03, 0x72, 0x70, 0x63, 0x22, 0x2e, 0x0a, 0x0f, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x6e, 0x66,
	...
	0x65, 0x55, 0x75, 0x69, 0x64, 0x22, 0xa3, 0x01, 0x0a, 0x10, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x6e,
	...
	0x09, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x32, 0x46, 0x0a, 0x0b, 0x46,
	0x69, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x37, 0x0a, 0x08, 0x46, 0x69,
	0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x14, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x46, 0x69, 0x6c,
	0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x72,
...
var file_file_rpc_proto_goTypes = []interface{}{
	(*FileInfoRequest)(nil),  // 0: rpc.FileInfoRequest
	(*FileInfoResponse)(nil), // 1: rpc.FileInfoResponse
}
var file_file_rpc_proto_depIdxs = []int32{
	0, // 0: rpc.FileService.FileInfo:input_type -> rpc.FileInfoRequest
	1, // 1: rpc.FileService.FileInfo:output_type -> rpc.FileInfoResponse
