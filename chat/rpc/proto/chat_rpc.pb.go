...
type UserChatRequest struct {
	...
	ChatMsg []byte `protobuf:"bytes,1,opt,name=chatMsg,proto3" json:"chatMsg,omitempty"` // 聊天消息， 一个完整的 chatModel 的序列化数据
}
...
func (x *UserChatRequest) GetChatMsg() []byte {
	if x != nil {
		return x.ChatMsg
	}
	return nil
...
var file_chat_rpc_proto_rawDesc = []byte{
	...
	,
...
var file_chat_rpc_proto_goTypes = []interface{}{
	(*UserChatRequest)(nil), // 0: rpc.UserChatRequest
	(*NoneResponse)(nil),    // 1: rpc.NoneResponse
}
var file_chat_rpc_proto_depIdxs = []int32{
	0, // 0: rpc.ChatService.UserChat:input_type -> rpc.UserChatRequest
	1, // 1: rpc.ChatService.UserChat:output_type -> rpc.NoneResponse
